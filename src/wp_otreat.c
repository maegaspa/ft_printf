...
int			wp_otreat(t_flag flag, long long dig)
{
    ...
    o_treat_1(flag, dig, nbr, nb_char);
    o_treat_2(flag, dig, nbr, nb_char);
    o_treat_3(flag, dig, nbr, nb_char);
    ...
    {
        o_treat_4(flag, dig, nbr, nb_char);
        o_treat_5(flag, dig, nbr, nb_char);
    ...
    o_treat_6(flag, dig, nbr, nb_char);
    o_treat_7(flag, dig, nbr, nb_char);
    o_treat_8(flag, dig, nbr, nb_char);
    /*if (flag.width > 0 && dig == 0 && flag.point && !flag.precision)
        ...
        ft_putstr(nbr);*/
    o_treat_9(flag, dig, nbr, nb_char);
    /*if (flag.width > 0 && flag.point > 0 && !flag.precision && flag.minus > 0)
    {
        putspace = flag.width - ft_strlen(nbr);
        if (flag.hashtag > 0)
    ...
    o_treat_10(flag, dig ,nbr, nb_char);
    return(ft_strlen(nbr) + nb_char);
}
