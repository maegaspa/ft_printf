...
void                        d_treat_1(t_flag flag, long long dig, char *len, int nb_char);
void                        d_treat_2(t_flag flag, long long dig, char *len, int nb_char);
void                        d_treat_3(t_flag flag, long long dig, char *len, int nb_char);
void                        d_treat_4(t_flag flag, long long dig, char *len, int nb_char);
void                        d_treat_5(t_flag flag, long long dig, char *len, int nb_char);
int                         d_treat_6(t_flag flag, long long dig, char *len, int nb_char);
int                         d_treat_7(t_flag flag, long long dig, char *len, int nb_char);
void                        o_treat_1(t_flag flag, long long dig, char *nbr, int nb_char);
void                        o_treat_2(t_flag flag, long long dig, char *nbr, int nb_char);
void                        o_treat_3(t_flag flag, long long dig, char *nbr, int nb_char);
void                        o_treat_4(t_flag flag, long long dig, char *nbr, int nb_char);
void                        o_treat_5(t_flag flag, long long dig, char *nbr, int nb_char);
void                        o_treat_6(t_flag flag, long long dig, char *nbr, int nb_char);
void                        o_treat_7(t_flag flag, long long dig, char *nbr, int nb_char);
void                        o_treat_8(t_flag flag, long long dig, char *nbr, int nb_char);
int                         o_treat_9(t_flag flag, long long dig, char *nbr, int nb_char);
void                        o_treat_10(t_flag flag, long long dig, char *nbr, int nb_char);
void                        ox_treat_1(t_flag flag, long long dig, char *nbr, int nb_char);
void                        ox_treat_2(t_flag flag, long long dig, char *nbr, int nb_char);
void                        ox_treat_3(t_flag flag, long long dig, char *nbr, int nb_char);
